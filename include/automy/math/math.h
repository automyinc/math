...
#ifndef INCLUDE_AUTOMY_MATH_MATH_H_
#define INCLUDE_AUTOMY_MATH_MATH_H_

/// Note: Include this file only in *.cpp files.
...
#endif /* INCLUDE_AUTOMY_MATH_MATH_H_ */
